...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name omniwheel_control-msg:<num> is deprecated: use omniwheel_control-msg:num instead.")))

(cl:ensure-generic-function 'cell-val :lambda-list '(m))
(cl:defmethod cell-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omniwheel_control-msg:cell-val is deprecated.  Use omniwheel_control-msg:cell instead.")
  (cell m))
