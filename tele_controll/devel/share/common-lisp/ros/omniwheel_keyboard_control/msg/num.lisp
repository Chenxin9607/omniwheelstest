...
(cl:defmethod cl:initialize-instance :after ((m <num>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'num)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name omniwheel_keyboard_control-msg:<num> is deprecated: use omniwheel_keyboard_control-msg:num instead.")))

(cl:ensure-generic-function 'cell-val :lambda-list '(m))
(cl:defmethod cell-val ((m <num>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader omniwheel_keyboard_control-msg:cell-val is deprecated.  Use omniwheel_keyboard_control-msg:cell instead.")
  (cell m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<num>)))
  ...
  "omniwheel_keyboard_control/num")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'num)))
  "Returns string type for a message object of type 'num"
  "omniwheel_keyboard_control/num")
