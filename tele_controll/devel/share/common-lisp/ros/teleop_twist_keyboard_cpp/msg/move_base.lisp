...
(cl:defmethod cl:initialize-instance :after ((m <move_base>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'move_base)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teleop_twist_keyboard_cpp-msg:<move_base> is deprecated: use teleop_twist_keyboard_cpp-msg:move_base instead.")))

(cl:ensure-generic-function 'v_right-val :lambda-list '(m))
(cl:defmethod v_right-val ((m <move_base>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleop_twist_keyboard_cpp-msg:v_right-val is deprecated.  Use teleop_twist_keyboard_cpp-msg:v_right instead.")
  (v_right m))

(cl:ensure-generic-function 'v_left-val :lambda-list '(m))
(cl:defmethod v_left-val ((m <move_base>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleop_twist_keyboard_cpp-msg:v_left-val is deprecated.  Use teleop_twist_keyboard_cpp-msg:v_left instead.")
  (v_left m))

(cl:ensure-generic-function 'v_back-val :lambda-list '(m))
(cl:defmethod v_back-val ((m <move_base>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teleop_twist_keyboard_cpp-msg:v_back-val is deprecated.  Use teleop_twist_keyboard_cpp-msg:v_back instead.")
  (v_back m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<move_base>)))
  ...
  "teleop_twist_keyboard_cpp/move_base")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'move_base)))
  "Returns string type for a message object of type 'move_base"
  "teleop_twist_keyboard_cpp/move_base")
